...
if TYPE_CHECKING:
    ...
    VLLM_PROFILE_LAYER_SCOPES: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Add per-layer detail to optional custom profiler scopes
    "VLLM_PROFILE_LAYER_SCOPES": lambda: bool(
        int(os.getenv("VLLM_PROFILE_LAYER_SCOPES", "0"))
    ),
